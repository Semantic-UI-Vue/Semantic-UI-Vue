<template>
  <sui-segment>
    <sui-image src="static/images/wireframes/image-text.png" size="small" floated="left" />
    <p>
    ...
    <sui-image src="static/images/wireframes/image-text.png" size="small" floated="right" />
    <p>
