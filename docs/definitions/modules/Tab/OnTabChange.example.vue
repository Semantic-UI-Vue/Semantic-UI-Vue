    ...
    <p>
      ...
      <template>
        <a
          href="#"
          v-if="table.index !== 0"
          @click.prevent="activatePane(0)"
        >Circle</a>
        <span v-else>Circle</span>
      </template>,
      <template>
        <a
          href="#"
          v-if="table.index !== 1"
          @click.prevent="activatePane(1)"
        >Box</a>
      ...
      <template>
        <a
          href="#"
          v-if="table.index !== 2"
          @click.prevent="activatePane(2)"
        >Triangle</a>
        <span v-else>Triangle</span>
      </template>,
    </p>
    ...
    <sui-table fixed compact="very">
      <sui-table-body>
        ...
        <sui-table-row>
          ...
          <sui-table-cell><code>{{ table.inside }}</code></sui-table-cell>
        </sui-table-row>
      </sui-table-body>
    </sui-table>
