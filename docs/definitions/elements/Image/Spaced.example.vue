<template>
  <div>
    <sui-segment>
      <p>
        Te eum doming eirmod, nominati pertinacia <sui-image :src="src" size="mini" spaced />
    ...
    <p>
      <sui-image :src="src" size="mini" spaced="right" />Audiam quaerendum eu sea, pro omittam
